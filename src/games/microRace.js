 ...
 * Fast top-down kart racing, drifting, turbo boost pads, lap countdown!
 */
...
export class MicroRace {
  ...
  computeBotInput() {
    // Waypoints along track: Bottom-left -> Top-left -> Top-right -> Bottom-right
    const waypoints = [
